...
import { GetDashboardDTO, GetFinancialEvolutionDTO, IndexTransactionsDTO } from "../../dtos/transactions.dtos"
import { Balance } from "../../entities/balance.entity"
import { Expense } from "../../entities/expense.entity"
import { Transaction, TransactionType } from "../../entities/transactions.entity"
import { TransactionsModel } from "../schemas/transactios.schema"


export class TransactionsRepository {
    constructor(private model: typeof TransactionsModel) { }

    async create({ title, date, amount, type, category }:
        Transaction): Promise<Transaction> {
        const createTransaction = await this.model.create({
            title,
            date,
            amount,
            type,
